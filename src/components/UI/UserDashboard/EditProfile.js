        ...
        <Grid>
          <Box component="form" onSubmit={updateProfile} noValidate sx={{ mt: 1 }}>
            ...
            >
              ...
              <TextField hiddenLabel size="small" value={""} select fullWidth onChange={(e) => setSkills(e.target.value)}>
              ...
              <TextField hiddenLabel size="small" value={""} select fullWidth onChange={(e) => setNetworking(e.target.value)}>
            ...
            >
              ...
              <TextField hiddenLabel size="small" value={""} select fullWidth onChange={(e) => setIndustry(e.target.value)}>
